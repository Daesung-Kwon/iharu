...
> Android 스마트폰 + 태블릿 유니버설 앱을 Play Store에 배포하기 위한 완전한 가이드
...
- [ ] 빌드 성공 여부 확인
- [ ] APK 다운로드
- [ ] 실제 폰 또는 태블릿(또는 에뮬레이터)에 설치하여 테스트
...
#### 전체 설명 (최대 4000자)
```
i하루는 아이들이 스스로 하루 일과를 계획하고 관리할 수 있는 Android 스마트폰 + 태블릿 유니버설 앱입니다.
...
스마트폰과 태블릿에서 사용할 수 있는 유니버설 앱입니다.
```
...
폰 form factor를 연 뒤에는 **Android phone** 샷이 필요하다. 기존 태블릿 샷은 유지한다. 촬영 체크리스트: [MOBILE_EXPANSION.md](./MOBILE_EXPANSION.md).
...
1. **기기 호환성**
   - Play Console에서 **phone form factor** 포함
   - 태블릿 샷은 유지하고 폰 스크린샷을 추가
...
3. **스크린샷**
   - 폰 + 태블릿 화면 비율로 제작
   - 체크리스트: [MOBILE_EXPANSION.md](./MOBILE_EXPANSION.md)
